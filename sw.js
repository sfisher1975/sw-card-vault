const C='sw-card-vault-v10';const A=['./','./index.html','./cards-v10.json?build=10','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
...
if(u.pathname.endsWith('/cards-v10.json')){e.respondWith(fetch(e.request,{cache:'no-store'}).catch(()=>caches.match(e.request)));return;}
