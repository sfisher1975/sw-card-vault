const C='sw-card-vault-v9';const A=['./','./index.html','./cards-v9.json?build=9','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
...
if(u.pathname.endsWith('/cards-v9.json')){e.respondWith(fetch(e.request,{cache:'no-store'}).catch(()=>caches.match(e.request)));return;}
