const C='sw-card-vault-v12';const A=['./','./index.html','./cards-v12.json?build=12','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
...
if(u.pathname.endsWith('/cards-v12.json')){e.respondWith(fetch(e.request,{cache:'no-store'}).catch(()=>caches.match(e.request)));return;}
