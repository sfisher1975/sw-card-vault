const C='sw-card-vault-v8';const A=['./','./index.html','./cards-v8.json?build=8','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
...
if(u.pathname.endsWith('/cards-v8.json')){e.respondWith(fetch(e.request,{cache:'no-store'}).catch(()=>caches.match(e.request)));return;}
