const C='sw-card-vault-v7';const A=['./','./index.html','./cards-v7.json?build=7','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
...
if(u.pathname.endsWith('/cards-v7.json')){e.respondWith(fetch(e.request,{cache:'no-store'}).catch(()=>caches.match(e.request)));return;}
