const C='sw-card-vault-v6';const A=['./','./index.html','./cards-v6.json?build=6','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
...
self.addEventListener('fetch',e=>{if(e.request.method!=='GET')return;
 ...
 if(u.pathname.endsWith('/cards-v6.json')){e.respondWith(fetch(e.request,{cache:'no-store'}).catch(()=>caches.match(e.request)));return;}
